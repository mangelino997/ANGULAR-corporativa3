...
export class RolComponent implements OnInit {
  ...
  constructor(private rolPestania: Rol,private subopcionPestaniaServicio: SubopcionPestaniaService, private rolServicio: RolService, private toastr: ToastrService) {
  ...
  ngOnInit() {
    ...
    this.formulario= this.rolPestania.formulario;
...
//Obtiene el ID del modulo traido desde la base de datos y lo muestra en el campo id del formulario.
  ...
  //Agrega un registro 
  private agregar(){
    this.rolServicio.agregar(this.formulario.value).subscribe(
      res => {
  ...
  private actualizar(){
    this.rolServicio.actualizar(this.formulario.value).subscribe(
      res => {
        var respuesta = res.json();
