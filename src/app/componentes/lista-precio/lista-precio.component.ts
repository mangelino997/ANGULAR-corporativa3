...
import { ListaPrecio } from 'src/app/modelos/listaPrecio';
...
export class ListaPrecioComponent implements OnInit {
  ...
  constructor(private listaPrecioService: ListaPrecioService, private listaPrecio: ListaPrecio, private subopcionPestaniaServicio: SubopcionPestaniaService, private toastr: ToastrService) { 
