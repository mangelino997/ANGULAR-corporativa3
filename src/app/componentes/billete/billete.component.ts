...
@Component({
  selector: 'app-billete',
  templateUrl: './billete.component.html',
  styleUrls: ['./billete.component.scss']
})
export class BilleteComponent implements OnInit {
  ...
  constructor(private billeteService: BilleteService, private billete: Billete, private subopcionPestaniaServicio: SubopcionPestaniaService, private toastr: ToastrService) { 
    this.autocompletado.valueChanges.subscribe(data => {
      if(typeof data == 'string') {
        this.billeteService.listarPorNombre(data).subscribe(res => {
  ...
  ngOnInit() {
      ...
      this.formulario= this.billete.formulario;
...
//Obtiene el ID del modulo traido desde la base de datos y lo muestra en el campo id del formulario.
  private obtenerSiguienteId(){
    this.billeteService.obtenerSiguienteId().subscribe(
      res => {
        console.log(res);
  ...
  private listar(){
    this.billeteService.listar().subscribe(
      res => {
  ...
  //Agrega un registro 
  private agregar(){
    this.billeteService.agregar(this.formulario.value).subscribe(
      res => {
  ...
  private actualizar(){
    this.billeteService.actualizar(this.formulario.value).subscribe(
      res => {
        var respuesta = res.json();
  ...
  //Elimina un registro
  private eliminar(){
    this.billeteService.agregar(this.formulario.get('id').value).subscribe(
      res => {
        console.log(res);
      },
      err => {
