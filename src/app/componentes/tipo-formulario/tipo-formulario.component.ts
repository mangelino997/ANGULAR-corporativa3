...
@Component({
  ...
  styleUrls: ['./tipo-formulario.component.scss']
})
...
constructor(private tipoFormularioService: TipoFormularioService, private tipoFormulario: TipoFormulario, private subopcionPestaniaServicio: SubopcionPestaniaService, private toastr: ToastrService) { 
  this.autocompletado.valueChanges.subscribe(data => {
    if(typeof data == 'string') {
      this.tipoFormularioService.listarPorNombre(data).subscribe(res => {
...
ngOnInit() {
  ...
  this.formulario= this.tipoFormulario.formulario;
...
this.tipoFormularioService.obtenerSiguienteId().subscribe(
  res => {
    console.log(res);
...
private listar(){
this.tipoFormularioService.listar().subscribe(
  res => {
...
//Agrega un registro 
private agregar(){
this.tipoFormularioService.agregar(this.formulario.value).subscribe(
  res => {
...
private actualizar(){
this.tipoFormularioService.actualizar(this.formulario.value).subscribe(
  res => {
    var respuesta = res.json();
...
//Elimina un registro
private eliminar(){
this.tipoFormularioService.agregar(this.formulario.get('id').value).subscribe(
  res => {
    console.log(res);
  },
  err => {
