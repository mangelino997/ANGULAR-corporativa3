...
export class GastoComponent implements OnInit {
  ...
  constructor(private gastoService: GastoService, private gasto: Gasto, private subopcionPestaniaServicio: SubopcionPestaniaService, private toastr: ToastrService) { 
    this.autocompletado.valueChanges.subscribe(data => {
      if(typeof data == 'string') {
        this.gastoService.listarPorAlias(data).subscribe(res => {
  ...
  ngOnInit() {
    ...
    this.formulario= this.gasto.formulario;
...
//Obtiene el ID del modulo traido desde la base de datos y lo muestra en el campo id del formulario.
  private obtenerSiguienteId(){
    this.gastoService.obtenerSiguienteId().subscribe(
      res => {
        console.log(res);
  ...
  //Agrega un registro 
  private agregar(){
    this.gastoService.agregar(this.formulario.value).subscribe(
      res => {
  ...
  private actualizar(){
    this.gastoService.actualizar(this.formulario.value).subscribe(
      res => {
        var respuesta = res.json();
  ...
  //Elimina un registro
  private eliminar(){
    this.gastoService.agregar(this.formulario.get('id').value).subscribe(
      res => {
        console.log(res);
      },
      err => {
