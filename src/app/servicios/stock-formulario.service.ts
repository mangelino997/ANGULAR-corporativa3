...
export class StockFormularioService {
  //define la url contra el servicio web
  private url: string;
  private opciones: any;
  //constructor
  constructor(private appService: AppService, private http: Http) {
    this.url = appService.getUrlBase() + '/formularioTransferencia';
  ...
  //obtiene la lista completa de registros de Almacen Agrupados Por Tipo Formulario
  public listarFormulariosAlmacenAgrupadosPorTipoFormulario() {
    return this.http.get(this.url+'/listarFormulariosAlmacenAgrupadosPorTipoFormulario');
  }
  //obtiene la lista completa de registros de Mostrador Agrupados Por Tipo Formulario
  public listarFormulariosMostradorAgrupadosPorTipoFormulario() {
    return this.http.get(this.url+'/listarFormulariosMostradorAgrupadosPorTipoFormulario');
  }
