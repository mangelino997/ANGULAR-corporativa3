...
const routes: Routes = [
  ...
  {path: 'compraslistasdeprecios', component: ListaPrecioCompraComponent, canActivate: [GuardiaService]},
  ...
  {path: 'extraslistasdeprecios', component: ListaPrecioComponent, canActivate: [GuardiaService]},
